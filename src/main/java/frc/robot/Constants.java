...
public final class Constants {
  ...
  public static final class Arm {
    ...
    public static final double kSoftLimitReverse = -1.15; // 1.15
    public static final double kSoftLimitForward = 0.0; // 0.0
    ...
    public static final double kIntakePosition = -1.15; // -1.17
  }
  ...
  public static final class Intake {
    ...
    public static final double kIntakePower = 0.7; // 0.7
    public static final double kRevIntakePower = -0.3;
  ...
  public static final class Launcher {
    ...
    public static final double kTopPower = 0.8;
    public static final double kBottomPower = 0.9;

    public static final double kInverseTopPower = -0.1;
    public static final double kInverseBottomPower = -0.1;
  }
  ...
  public static final class ModuleConstants {
    ...
    public static final int kDrivingMotorPinionTeeth = 14; // high gear
