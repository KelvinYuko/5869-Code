...
public class IntakeSubsystem extends SubsystemBase {
  ...
  public IntakeSubsystem() {
    ...
    intakeMotor = new CANSparkFlex(Constants.Intake.kCanId, MotorType.kBrushless);
    intakeMotor.setInverted(false);
    intakeMotor.setSmartCurrentLimit(Constants.Intake.kCurrentLimit);
    intakeMotor.setIdleMode(IdleMode.kBrake);

    m_encoder = intakeMotor.getEncoder(SparkRelativeEncoder.Type.kHallSensor, 42);

    m_controller = intakeMotor.getPIDController();
